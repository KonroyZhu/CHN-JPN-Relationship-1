...
url = 'http://news.sogou.com/news?mode=2&manual=true&query=site%3Aqq.com+%D6%D0%C8%D5&sort=1&page=1&p=42230302&dp=1'
#抓取页码内容，返回响应对象
...
soup = bs4.BeautifulSoup(response.content.decode("GB18030"))
print(soup)
